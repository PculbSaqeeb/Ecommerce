...
const About = () => {
  return (
    ...
    //   </div>
    // </div>
    <div className="flex flex-col lg:flex-row gap-[18px] mb-[78px] px-4 lg:px-8">
      {/* Text Section */}
      <div className="lg:mx-[50px] mx-3">
        <p className="text-[28px] sm:text-[32px] lg:text-[36px] font-bold text-textPrimary dark:text-white mt-[40px] lg:mt-[80px]">
          About Us
        </p>
        <p className="mt-[20px] sm:mt-[25px] text-2xl sm:text-xl lg:text-2xl font-bold text-textPrimary dark:text-white">
          Business Name
        </p>
        <p className="mt-[20px] sm:mt-[24px] w-full lg:w-[882px] text-textPrimary dark:text-white text-[16px] sm:text-[20px] lg:text-[18px] text-justify">
        ...
        <p className="text-[18px] sm:text-[20px] lg:text-[18px] font-bold mt-[20px] lg:mt-[26px] text-textPrimary dark:text-white">
          Contact Information
        </p>
        <p className="mt-[10px] text-textPrimary dark:text-white text-[16px] sm:text-[20px] lg:text-[18px]">
          +91 1234567890
        </p>
        <p className="mt-[10px] text-textPrimary dark:text-white text-[16px] sm:text-[20px] lg:text-[18px]">
          Somthing@gamil.com
