    ...
    <div>
      <div className="w-full bg-[#00071B] text-white">
        <div className="flex items-center gap-[29px] pl-[50px]">
          <img className="w-[76px] h-[64px] mt-[44px]" src={logo_white} alt="" />
          <p className="text-[64px] font-bold text-white mt-[36px]">Globex</p>
        </div>

        <div className="flex gap-[110px] ml-[179px] mt-[90px]">
          <ul className=" flex flex-col gap-[17px] cursor-pointer text-[18px]">
            <li className="text-[24px] font-bold">Women</li>
          ...
          <ul className="flex flex-col gap-[17px] cursor-pointer text-[18px]">
            <li className="text-[24px] font-bold">Men</li>
          ...
          <ul className="flex flex-col gap-[17px] cursor-pointer text-[18px]">
            <li className="text-[24px] font-bold">Kids</li>
          ...
          <ul className="flex flex-col gap-[16px] cursor-pointer text-[18px]">
            <li className="text-[24px] font-bold">Stay in Touch</li>
            <li className="w-[445px] h-[44px] text-lg">
              Stay in touch to get special offers, free giveaways and once in a
              lifetime deals
            </li>
            <li>
              <div className="flex relative mt-[16px]">
                <input className="pl-[69px] bg-[#00071B] border border-[#ABABAB] w-[447px] h-[44px] text-[18px] placeholder:text-[18px]" type="text" placeholder="Enter your email"  />
        ...
        <div className="mt-[39px] pb-[38px]">
            <ul className="flex justify-center gap-[200px] text-[18px]">
